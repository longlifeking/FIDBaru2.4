      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-md-12 p-3">
            <h3 class="font-family-inter">DATA MONITORING PANGKALAN SUSU YANG DISETUJUI ZONA 1 </h3>
          </div>
        </div>
      </div>
                ...
                <tbody>
                    @if ($flowlines->isNotEmpty())
                        @foreach ($flowlines->sortBy('slug') as $flowlines)
                          @php
                          $cardValuesPangsu = ($flowlines->Nilai_ProyekUSD/($flowlines->panjang_3inch + $flowlines->panjang_2inch));
                          @endphp
                            <tr>
                                ...
                                <td>USD {{  round($cardValuesPangsu) }} Meter/Inch</td>
                                <td>
