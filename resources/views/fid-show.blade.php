            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @foreach($fidtabel->ruanglingkup as $rl)
                        <li><a href="/afe-showrl/{{$rl->id}}">{{ $rl->judulrl }}</a></li>
                    @endforeach
                    </ul>
                    <p><strong>File Persetujuan FID : </strong><a href="{{ route('fid.download', $fidtabel->id) }}">Download</a></p> <!--ada yang salah-->
                    <p><strong>File Persetujuan POD : </strong><a href="{{ route('pod.download', $fidtabel->id) }}">Download</a></p>
                </div>
            </div>
        </div>
    </div>
