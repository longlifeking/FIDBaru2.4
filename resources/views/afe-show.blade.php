        ...
        <div class="col-md-13">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <p><strong>File PS AFE Yang Disetujui : </strong><a href="{{ route('PS.download', $afetabels->id) }}">Download</a></p>
                    <p><strong>File BS AFE Yang Disetujui : </strong><a href="{{ route('BS.download', $afetabels->id) }}">Download</a></p>
                    <p><strong>File Persetujuan PIS / PPP : </strong><a href="{{ route('PISPPP.download', $afetabels->id) }}">Download</a></p>
                    <p><strong>File Persetujuan COR : </strong><a href="{{ route('COR.download', $afetabels->id) }}">Download</a></p>
