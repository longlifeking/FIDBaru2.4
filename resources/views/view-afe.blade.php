  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-md-12 p-3">
        <h3 class="font-family-inter">DATA MONITORING AFE YANG DISETUJUI ZONA 1 </h3>
      </div>
    </div>
  </div>
    <div class="col-md-12 mb-3">
      <div class="card">
        <div class="card-header">
          <span><i class="bi bi-table me-2"></i></span> Data AFE YANG DISETUJUI
        </div>
        <div class="card-body">
            ...
            <table id="example" class="table table-striped data-table" style="width: 100%">
              ...
              <thead>
                  <tr>
                    <th>No</th>
                    <th>Judul FID</th>
                    <th>Nilai AFE YANG DISETUJUI </th>
                  </tr>
                </thead>
            <tbody>
