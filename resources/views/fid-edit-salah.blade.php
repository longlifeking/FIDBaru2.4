              ...
              <div class="card-body">
                ...
                <div id="ruangLingkupContainer">
                  @foreach ($Fid_all->ruangLingkup as $index => $rl)
                    <div class="mb# Since the user's message was cut off, I'll need to continue the rest of the blade template for them.
                    <div class="mb-3 ruang-lingkup">
                      ...
                      <button type="button" class="btn btn-danger btn-remove-ruang-lingkup" data-id="{{ $rl->id }}">Hapus</button>
                    </div>
                  @endforeach
                </div>
                <div class="mb-3">
                  <label for="formFile" class="form-label">File Persetujuan FID</label>
                  <input class="form-control" type="file" name="filepath" id="formFile">
                </div>
