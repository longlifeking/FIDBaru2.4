      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-md-12 p-3">
            <h3 class="font-family-inter">DATA MONITORING FLOWLINE RANTAU YANG DISETUJUI ZONA 1 </h3>
          </div>
        </div>
      </div>
              ...
              <table id="example" class="table table-striped data-table" style="width: 100%">
                ...
                <tbody>
                    @if ($flowlines->isNotEmpty())
                        ...
                        @php
                              $cardValuesRantau = ($flowlines->Nilai_ProyekUSD/($flowlines->panjang_3inch + $flowlines->panjang_2inch));
                          @endphp
                            <tr>
                                ...
                                <td> USD {{ round($cardValuesRantau) }} Meter/Inch</td>
